...
def get_parser():
    parser = argparse.ArgumentParser(
        ...
        This software generates an Excel file (also JSON and CSV) containning all inforamtion from the Registre des interventions d'Urgence-Environnement Québec.
...
def main():
    ...
    db.update_and_write_items(data)
